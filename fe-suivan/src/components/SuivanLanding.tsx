          ...
          <div className="grid gap-4">
            {showSkeleton ? (
              ...
              displayPools.map((pool, i) => (
                <article className="suivan-reveal p-5 md:p-6" key={pool.address || `pool-${i}`} style={{ background: "var(--brutal-bg)", border: "4px solid var(--brutal-ink)", boxShadow: "8px 8px 0 var(--brutal-ink)", color: "var(--brutal-ink)" }}>
