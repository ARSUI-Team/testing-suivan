...
const en: Record<string, string> = {
  ...
  "faq.a4": "Sui's object-centric model makes every pool a live on-chain object you can inspect at any time. Sub-second finality means instant settlement. Gas fees are zero — fully sponsored by the protocol. Seal RNG provides verifiable fair random winner selection. Walrus stores pool metadata permanently. This stack is impossible on any other chain.",
  ...
  "faq.a11": "You pay zero gas. Every transaction on Suivan — join, deposit, claim, start pool — is sponsored by the protocol. Your wallet balance stays untouched. This is made possible by Sui's ultra-low transaction costs (~$0.0002 per tx), making full sponsorship economically sustainable at scale.",
  ...
  "landing.whySui": "Sui",
  "landing.whyDesc": "Sui's object-centric model makes every ROSCA pool an inspectable on-chain entity. Combined with zero-gas sponsored transactions and Walrus blob storage, Suivan delivers a seamless community finance experience.",
  ...
  "demo.step": "Step",
  "demo.step1Detail": "Connect any Sui wallet in seconds. No seed phrase stress — install, connect, done. All gas fees are sponsored.",
  "demo.step1Action": "Try Google Login",
  "demo.step2Detail": "Browse available pools (Small: 10 USDC, Medium: 50 USDC, Large: 100 USDC). Deposit collateral once — your commitment to the group. All gas is sponsored — you pay zero.",
  ...
  "faucet.subtitle": "Claim 500 USDC for testing. All transactions are sponsored — zero gas fees. Explore Suivan pools before mainnet.",
...
const id: Record<string, string> = {
  ...
  "faq.a3": "Cukup hubungkan Sui wallet — instalasinya gratis dan hanya butuh beberapa detik. Buka /faucet untuk klaim 500 USDC gratis. Lalu jelajahi /pools, pilih yang sesuai anggaranmu, dan gabung. Semua transaksi disponsori — kamu tidak pernah bayar gas.",
  ...
  "landing.whySui": "Sui",
  "landing.whyDesc": "Model object-centric Sui membuat setiap pool ROSCA menjadi entitas on-chain yang dapat diperiksa. Dengan transaksi disponsori tanpa gas dan penyimpanan Walrus, Suivan menghadirkan pengalaman keuangan komunitas yang mulus.",
  ...
  "demo.step": "Langkah",
  "demo.step1Detail": "Hubungkan Sui wallet apa pun dalam hitungan detik. Tanpa stres seed phrase — instal, hubungkan, selesai. Semua biaya gas disponsori.",
  "demo.step1Action": "Coba Login Google",
  "demo.step2Detail": "Jelajahi pool yang tersedia (Kecil: 10 USDC, Sedang: 50 USDC, Besar: 100 USDC). Setor jaminan sekali — komitmen Anda ke grup. Semua gas disponsori — Anda bayar NOL.",
