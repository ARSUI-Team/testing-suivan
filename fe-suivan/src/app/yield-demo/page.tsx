...
const YIELD_STEPS = [
 ...
 { id: 2, title: "Flash Loan from YIELD SIGNALS", desc: "Borrow base/quote asset, execute swap pair, capture arbitrage profit.", icon: "⚡" },
 ...
 const handleSimulateYield = () => {
  ...
  const interval = setInterval(() => {
   ...
   if (step >= YIELD_STEPS.length) {
    ...
    setTxStatus("success");
    setTxDigest("Simulated: YIELD SIGNALS flash loan arbitrage flow");
    refetchBalances();
   }
  }, 800);
 };
      ...
      <div className="border-b-[3px] border-[#0a0a0a] p-6">
       <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <select
         ...
         className="protocol-font border-[3px] border-[#0a0a0a] bg-[#fdfdfa] px-4 py-2 text-xs font-black shadow-[12px_12px_0_#0a0a0a] outline-none"
        >
    ...
    <div className="mx-auto max-w-6xl">
     <div className="overflow-hidden border-[3px] border-[#0a0a0a] bg-[#fdfdfa] shadow-[12px_12px_0_#0a0a0a]">
      ...
      <div className="grid gap-0 md:grid-cols-5">
       {YIELD_STEPS.map((step, i) => {
        ...
        return (
         <div
          key={step.id}
          className={`relative border-r-0 border-[#0a0a0a] p-5 transition-all duration-500 last:border-r-0 md:border-r-[3px] ${
           isActive
         ...
         >
          <div className={`mb-2 flex size-10 items-center justify-center border-[3px] text-lg transition-all ${
           isActive
      ...
      <div className="flex flex-wrap items-center gap-4 border-t-2 border-[#0a0a0a] p-6">
       <select
        className="protocol-font border-[3px] border-[#0a0a0a] bg-[#fdfdfa] px-4 py-3 text-xs font-black shadow-[12px_12px_0_#0a0a0a] outline-none"
        value={selectedPool ?? ""}
       ...
       <button
        ...
        className="protocol-font inline-flex items-center gap-2 border-[3px] border-[#0a0a0a] bg-[#0a0a0a] px-6 py-3 text-xs font-black text-[var(--background)] shadow-[12px_12px_0_#0a0a0a] transition-all hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[12px_12px_0_#0a0a0a] disabled:opacity-40 disabled:hover:translate-x-0 disabled:hover:translate-y-0 disabled:hover:shadow-[12px_12px_0_#0a0a0a]"
       >
    ...
    <div className="mx-auto max-w-6xl">
     <div className="overflow-hidden border-[3px] border-[#0a0a0a] bg-[#fdfdfa] shadow-[12px_12px_0_#0a0a0a]">
      ...
      <div className="grid gap-0 md:grid-cols-2">
       <div className="border-b-[3px] border-[#0a0a0a] p-6 md:border-b-0 md:border-r-2">
