    ...
    <main className="min-h-screen bg-[var(--brutal-bg)] text-[var(--brutal-ink)]">
      <section className="relative isolate overflow-hidden px-5 pb-6 pt-32 md:px-10 lg:px-12">
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            AI yield signals failed to load
          </h1>
          <p className="mt-6 max-w-2xl text-lg font-semibold leading-8 text-[var(--brutal-muted)]">
            {error.message || "An unexpected error occurred while loading yield signals. Please try again."}
          </p>
          <button
            onClick={reset}
            className="protocol-font mt-8 inline-flex items-center gap-2 border-[3px] border-[var(--brutal-ink)] bg-[var(--brutal-accent)] px-6 py-3 text-sm font-black text-[var(--brutal-ink)] shadow-[4px_4px_0_var(--brutal-ink)] transition hover:-translate-x-0.5 hover:-translate-y-0.5"
          >
            Try Again
          </button>
        </div>
