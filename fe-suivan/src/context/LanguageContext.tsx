...
const en: Record<string, string> = {
  ...
  "ai.howStep1": "Pool funds withdrawn via hot potato pattern (atomic — if any step fails, everything rolls back)",
  "ai.howStep2": "Flash loan borrowed from DeepBook → arbitrage executed across DEX and lending pools",
  "ai.howStep3": "Profit deposited to yield_balance (accumulates for gacha jackpot)",
  "ai.howStep4": "At pool end → one gacha winner takes all accumulated yield",
...
const id: Record<string, string> = {
  ...
  "ai.howStep1": "Dana pool ditarik via hot potato pattern (atomik — jika gagal, transaksi di-rollback)",
  "ai.howStep2": "Flash loan dipinjam dari DeepBook → arbitrase dieksekusi di DEX dan lending pool",
  "ai.howStep3": "Profit disetor ke yield_balance (terkumpul untuk jackpot gacha)",
  "ai.howStep4": "Di akhir pool → satu pemenang gacha mengambil semua yield",
  "ai.deepbookTitle": "DeepBook V3 — Live",
